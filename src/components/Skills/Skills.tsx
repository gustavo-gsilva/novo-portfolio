...
function Skills() {
   return (
      <section
         className="
         flex items-center flex-col gap-16"
      >
         <h1
            className="
         ...
         <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 px-10 pb-16">
            <div
               ...
               hover:border-orange-400 duration-500
               shadow-orange">
               <img className="w-24 sm:w-28" src={iconHtml} alt="Logo HTML" />

               <h3
                  className="
                  text-[1.8rem] sm:text-[2rem] text-blue-50 font-medium uppercase">
                  Html
               </h3>
            </div>
            ...
            <div className="
               ...
               py-11 px-10
               border-2 border-gray-700
               hover:border-blue-500 duration-500
               shadow-blue">
            ...
            <div className="
               ...
               py-11 px-10
               border-2 border-gray-700
               hover:border-yellow-400 duration-500
               shadow-yellow">
               <img className="w-24 sm:w-28" src={iconJavaScript} alt="Logo JavaScript" />

               <h3 className="
                  text-[1.8rem] sm:text-[2rem] text-blue-50 font-medium">
                  JavaScript
               </h3>
            </div>
            ...
            <div className="
               ...
               py-11 px-10
               border-2 border-gray-700
               hover:border-blue-400 duration-500
               shadow-aqua">
            ...
            <div className="
               ...
               py-11 px-10
               border-2 border-gray-700
               hover:border-red-500 duration-500
               shadow-red">
            ...
            <div className="
               ...
               py-11 px-10
               border-2 border-gray-700
               hover:border-white duration-500
               shadow-white">
